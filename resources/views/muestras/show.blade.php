        ...
        <div class="row">
            <div class="col-md-12 col-md-offset-0">
                <div class="panel panel-default">
                    <div class="panel-heading"> Clientes con Muestras Entregadas </div>
                    <div class="panel-body">
                        <a href="{{ route('customers.create') }}" class="btn btn-info">Nuevo Cliente</a>
                    <!-- BUSCAR CLIENTES -->
                        {!! Form::open(['action' => 'MuestraCustomerController@show', 'method' => 'GET', 'class' => 'navbar-form navbar-right']) !!}
                    ...
                    <!-- FIN DEL BUSCADOR -->
                        ...
                        <table class="table table-striped table-bordered table-hover table-condensed">
                            ...
                            @foreach($customers as $customer)
                                <tr>
                                    <td align="center"><a href="{{ route('muestras', $customer->id) }}" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span></a></td>
