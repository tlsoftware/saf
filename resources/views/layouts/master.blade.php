...
<html>
<head>
    <title>ShareShare Webtool</title>
    <meta charset="utf-8">
    ...
    {{--<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.11.4/jquery-ui.theme.css" type="text/css"/>--}}
    ...
    <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.10.9/js/dataTables.jqueryui.min.js"></script>
    ...
    <script type="text/javascript" charset="utf8" src="//cdn.datatables.net/buttons/1.0.3/js/buttons.flash.min.js"></script>
    ...
    <script type="text/javascript" charset="utf8" src="//cdn.datatables.net/buttons/1.0.3/js/buttons.print.min.js"></script>
    <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/buttons/1.0.3/js/buttons.colVis.min.js"></script>
